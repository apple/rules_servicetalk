...
# `rules_servicetalk` Contributors Guide
...
`rules_servicetalk` is released under the Apache 2.0 license.
...
To file a bug or feature request, use [GitHub Issues](https://github.com/apple/rules_servicetalk/issues/new).
